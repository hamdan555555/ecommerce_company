  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child: GetBuilder<CompanySignUpControllerImp>(
          builder: (controller) => controller.statusRequest ==
              ...
              : Container(
                  padding:
                      const EdgeInsets.symmetric(vertical: 15, horizontal: 300),
                  child: WillPopScope(
                    ...
                    child: Form(
                      ...
                      child: ListView(
                        children: [
                                ...
                                decoration: InputDecoration(
                                  ...
                                  focusedBorder: OutlineInputBorder(
                                    ...
                                    borderSide: BorderSide(
                                        color: AppColor.colour7, width: 2),
                                  ),
                                ),
                          ...
                          CustomTextForm(
                            isNumber: false,
                            controller: controller.companystate,
                            hintText: "state",
                            labelText: "state",
                            iconData: Icons.location_on,
                            valid: (val) {
                          ...
                          CustomTextForm(
                            isNumber: false,
                            controller: controller.companystreet,
                            hintText: "street",
                            labelText: "street",
                            iconData: Icons.location_on,
                            valid: (val) {
                          ...
                          CustomTextForm(
                            isNumber: false,
                            controller: controller.companypayment,
                            hintText: "payment",
                            labelText: "payment",
                            iconData: Icons.location_on,
                            valid: (val) {
